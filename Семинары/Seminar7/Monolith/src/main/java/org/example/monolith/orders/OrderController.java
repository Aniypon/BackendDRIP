...
public class OrderController {
     ...
     */
    @PutMapping("/{id}/status-with-user-update")
    public ResponseEntity<String> updateOrderStatusAndUserActivity(
            @PathVariable Long id,
            @RequestParam String status) {
        try {
            orderService.updateOrderStatusAndUserActivity(id, status);
